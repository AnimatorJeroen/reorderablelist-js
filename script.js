...
function addTask() {
  ...
  <div class="grow-wrap">
    <textarea name="text" id="text" onInput="this.parentNode.dataset.replicatedValue = this.value"> ${taskName} </textarea>
  </div>
  </div>
  ...
  taskInput.value = "";
  taskList.prepend(newTask); // Use prepend instead of appendChild
}
